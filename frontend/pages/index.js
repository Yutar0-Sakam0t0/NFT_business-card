...
//　サイトアクセス時のデータ取得
  ...
  // ページ表示
  return (
    <div className={"flex flex-col items-center justify-center bg-slate-100 text-blue-900 min-h-screen overflow-hidden"}>
      <Head>
      ...
      <div className={"flex flex flex-col items-center justify-center"}>
        {account === "" ? (
          ...
          <div className={"flex flex-col items-center justify-center bg-slate-100 text-blue-900"}>
            <p className={"flex justify-center text-2xl font-bold pt-12"}>
              ブロックチェーンから
            </p>
